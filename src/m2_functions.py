...
def turtle4():
    ...
    will.speed = 10
    will.pen = rg.Pen('pink',10)
    will.paint_bucket = rg.PaintBucket('pink')
    will.right(270)
    will.backward(150)
    will.begin_fill()
    will.draw_square(100)
    will.end_fill()

def turtle5():
    becca = rg.SimpleTurtle()
    becca.speed = 20
    becca.pen = rg.Pen('aqua',10)
    becca.paint_bucket = rg.PaintBucket('aqua')
    becca.right(90)
    becca.forward(150)
    becca.begin_fill()
    becca.draw_circle(150)
    becca.end_fill()
