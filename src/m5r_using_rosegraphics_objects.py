...
#                 pen_down, pen_up, and pen.
#
#          -- Write the names of three INSTANCE VARIABLEs
#             that Circle objects have:
#                Radius, center_point, and outline_color.
#
#     f. What does a RoseWindow RENDER method do?
#           To send the order and make the previous order shown.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It is necessary when the RoseWindow has too many steps or is in a loop. \
#            Because it will be endless if there is no end instruction.
#
